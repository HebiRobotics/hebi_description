...
python3 "$PKG_DIR/scripts/urdf_generator.py" "$HRDF_LOCATION/hrdf/A-2240-05.hrdf"                  --urdfdir "$PKG_DIR/urdf/kits" --sdfdir "$PKG_DIR/models" --family Arm --actuators J1_base J2_shoulder J3_elbow J4_wrist1 J5_wrist2
