...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="omnibase",
            choices=["omnibase", "mecanum_base", "rosie"]
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            "prefix",
            default_value="",
            description="Prefix for the HEBI Base name.",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    hebi_base = LaunchConfiguration("hebi_base")
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare(description_package), "urdf", "kits", PythonExpression(['"', hebi_base, '.urdf.xacro"'])]
            ),
            " "
            "prefix:=",
